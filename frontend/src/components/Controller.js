...
const Controller = ({player, playPauseClicked, skipClicked, volumeChanged, muteClicked}) => {
        ...
        <div className={style.controller}>
            ...
            <div className={style.body}>
                <Can I={Capability.Pause}>
                    <button className={classnames(style.button, style.playPause)}
                            onClick={() => playPauseClicked(player.isPlaying)}>
                        <FontAwesomeIcon
                            icon={player.isPlaying ? "pause" : "play"}/> {player.isPlaying ? "Pause" : "Play"}
                    </button>
                </Can>
                <Can I={Capability.Skip}>
                    <button className={classnames(style.button, style.next)}
                            onClick={() => skipClicked()}>
                    ...
                    <div style={{display: 'flex', alignItems: 'center'}}>
                        <Can I={Capability.Pause}>
                            <FontAwesomeIcon icon="volume-up"
                                             ...
                                             onClick={() => muteClicked()}/></Can>
                        <Volume volume={player.volume} onUpdate={volumeChanged}/>
                    </div>
                </Can>
            </div>
        </div>)
