        ...
        <div className={style.songCard}>
            ...
            <div className={style.votes}>
                {!isAdminSong && can(Capability.Ban) && (
                    <button
                        className={classnames(style.button, style.ban, {
                ...
                {isAdminSong && canAdminQueue && (
                    <>
                        ...
                        <button
                            ...
                            onClick={() =>
                                moveUpAdminQueueClicked &&
                                moveUpAdminQueueClicked(song.adminIndex)
                            }
                        ...
                        <button
                            ...
                            onClick={() =>
                                moveDownAdminQueueClicked &&
                                moveDownAdminQueueClicked(song.adminIndex)
                            }
                ...
                {isAdminSong && (
                    <span
                        className={style.voteCount}
                        title="Promoted song: plays before other songs"
                    >
                        <FontAwesomeIcon
                            icon="star"
                            className={style.promoted}
                            size="xs"
                        />
                    </span>
                )}
                ...
                {canUpVote && (
                    <button
                        className={classnames(style.button, style.voteUp, {
                            [style.active]: song.userVote === 1,
                        })}
                ...
                {canDownVote && (
                    <button
                        className={classnames(style.button, style.voteDown, {
                            [style.active]: song.userVote === -1,
                        })}
                        onClick={(e) =>
                            voteDownClicked && voteDownClicked(song)
                        }
